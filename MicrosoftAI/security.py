...
if __name__ == "__main__":
    ...
    subscription_key = "<5ddPKARnWDwa7H8Ir8vL409wRQ2lUgaHvZrdXOfzCf7bjt2k7jZrJQQJ99AKACYeBjFXJ3w3AAAHACOGKii5>"
    endpoint = "<https://wayneaisecurity.cognitiveservices.azure.com/>"
